...
#%%
img = cv2.imread('../output_images/test5_persp.jpg')
binary_warped = cv2.cvtColor(img,cv2.COLOR_BGR2GRAY)
out_img, left_fit, right_fit, left_fitx, right_fitx = find_fit_polynomial(binary_warped)
plt.imshow(out_img)
# cv2.imwrite('../output_images/test5_sliding.jpg', out_img)

#%%
img = cv2.imread('../output_images/test4_persp.jpg')
binary_warped = cv2.cvtColor(img,cv2.COLOR_BGR2GRAY)
out_img2, left_fit2, right_fit2 = search_around_poly(binary_warped, left_fit, right_fit)
plt.imshow(out_img2)
# cv2.imwrite('../output_images/test5_prevpoly.jpg', out_img2)